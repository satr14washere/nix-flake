...
in {
  services.minecraft-servers.servers.${name} = {
    ...
    symlinks = inputs.mc.lib.collectFilesAt modpack "mods" // {
      ...
      "mods/LeavesBeGone.jar" = pkgs.fetchurl { url = ""; hash = ""; };
      ...
      "mods/ViaFabric.jar" = pkgs.fetchurl { url = "https://cdn.modrinth.com/data/YlKdE5VK/versions/gukVDlIF/ViaFabric-0.4.21%2B163-1.14-1.21.jar"; hash = "sha256-AWgu6i9jevJBqTxTyymNBSubvmpaB42zYp7eDqPZLwI="; };
