...
in {
  services.minecraft-servers.servers.${name} = {
    ...
    symlinks = {
      ...
      "mods/ViaFabric.jar" = pkgs.fetchurl { url = "https://cdn.modrinth.com/data/P1OZGk5p/versions/uz2jbJLI/ViaVersion-5.11.1-SNAPSHOT.jar"; hash = "sha256-xA5DOX2D3opxXldjVWytc3e579lKGy6o/84PtG3k4Vo="; };
      "mods/ViaVersion.jar" = pkgs.fetchurl { url = "https://cdn.modrinth.com/data/P1OZGk5p/versions/ZH8459B6/ViaVersion-5.11.0.jar"; hash = "sha256-idt2yOPmdCOPXu4rt6npor7roHYLvRuGSUd46KWlL3A="; };
