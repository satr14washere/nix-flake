...
in {
  services.minecraft-servers.servers.${name} = {
    ...
    symlinks = inputs.mc.lib.collectFilesAt modpack "mods" // {
      ...
      "mods/ViaFabric.jar" = pkgs.fetchurl { url = "https://cdn.modrinth.com/data/YlKdE5VK/versions/ghuh2MQh/ViaFabric-0.4.21%2B171-1.14-1.21.jar"; hash = "sha256-9LHsJuz5egNzams1rzveyp43RhVl+4UovhCI5CDmqDg="; };
