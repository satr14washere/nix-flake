...
in {
  services.minecraft-servers.servers.${name} = {
    ...
    symlinks = {
      ...
      "mods/ViaVersion.jar" = pkgs.fetchurl { url = "https://ci.viaversion.com/job/ViaVersion/1431/artifact/build/libs/ViaVersion-5.11.1-SNAPSHOT.jar"; hash = "sha256-KK8WrX2n68zuAChxVl/Q0esEl4aSMNdILgQMTR4dPyA="; };
      ...
      "mods/Geyser.jar" = pkgs.fetchurl { url = "https://download.geysermc.org/v2/projects/geyser/versions/2.11.0/builds/1205/downloads/fabric"; hash = "sha256-z6xIhR3lOYUn+zRKcNwOad/gYmSNGFY54jCwdzM/O2Q="; };
